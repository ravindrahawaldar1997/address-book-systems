...
public class AddressBookService {
    ...
    public void writeAddressBookDataData(List<ContactPerson> addressBookList) {
    ...
    public List<ContactPerson> getAddressBookData() {
        System.out.println("Storing Emp Payroll data from the file to obj");
        List<ContactPerson> addressDataFromFile = new ArrayList<>();
        try {
            Files.lines(Paths.get(address_DATA_FILE_PATH)).map(line -> {
                ...
                ContactPerson ab = new ContactPerson();
                return ab;
